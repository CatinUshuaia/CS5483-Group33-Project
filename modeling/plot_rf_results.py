...
pred_path = OUTPUT_DIR / "rf_test_predictions_no_clip.csv"
imp_path = OUTPUT_DIR / "rf_feature_importance_no_clip.csv"

pred_df = pd.read_csv(pred_path)
imp_df = pd.read_csv(imp_path)

# 图1：真实值 vs 预测值 分组柱状图
# 图1：真实值 vs 预测值 分组柱状图（调整 y 轴范围）
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "rf_true_vs_pred_bar_no_clip.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "rf_feature_importance_no_clip.png", dpi=300)
plt.show()